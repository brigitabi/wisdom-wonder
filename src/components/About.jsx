      ...
      <div className="m-4 pt-12">
        ...
        <div className="py-12 px-4 md:px-8">
          <div className="">
            ...
            <p>
              Wisdom Wonder is more than a company; it's a community.{' '}
              <span className="font-bold text-black underline hover:scale-105 cursor-pointer">
                Join us
              </span>{' '}
              on this remarkable journey to celebrate life's every chapter, and
